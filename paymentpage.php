...
<head>
  ...
  <title>Payments - Indoor Hub</title>
...
<div class="container-fluid">
  <div class="row">
    ...
    <nav class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item"><a class="nav-link active" href="paymentpage.php"><i class="bi bi-credit-card me-2"></i> Payments</a></li>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
      ...
      <!-- Make Payment Button -->
      <div class="text-end">
        <button class="btn btn-primary"><a class="nav-link" href="makepayment.html"><i class="bi bi-credit-card me-2"></i>Make Payment</a></button>
      </div>
